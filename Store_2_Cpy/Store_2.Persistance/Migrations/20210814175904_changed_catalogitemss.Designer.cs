...
namespace Store_2.Persistance.Migrations
{
    ...
    [Migration("20210814175904_changed_catalogitemss")]
    partial class changed_catalogitemss
    {
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 906, DateTimeKind.Local).AddTicks(6140));
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 924, DateTimeKind.Local).AddTicks(3687));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 924, DateTimeKind.Local).AddTicks(8949));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 925, DateTimeKind.Local).AddTicks(4353));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 925, DateTimeKind.Local).AddTicks(7921));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 926, DateTimeKind.Local).AddTicks(273));
            ...
            modelBuilder.Entity("Store_2.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 926, DateTimeKind.Local).AddTicks(3309));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 926, DateTimeKind.Local).AddTicks(7723));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 927, DateTimeKind.Local).AddTicks(1682));
            ...
            modelBuilder.Entity("Store_2.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 927, DateTimeKind.Local).AddTicks(3809));
            ...
            modelBuilder.Entity("Store_2.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 14, 22, 29, 2, 927, DateTimeKind.Local).AddTicks(5974));
