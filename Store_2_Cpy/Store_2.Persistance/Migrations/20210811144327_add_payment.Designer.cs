...
namespace Store_2.Persistance.Migrations
{
    ...
    [Migration("20210811144327_add_payment")]
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 709, DateTimeKind.Local).AddTicks(5830));
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 731, DateTimeKind.Local).AddTicks(479));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 731, DateTimeKind.Local).AddTicks(5455));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 731, DateTimeKind.Local).AddTicks(9143));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 732, DateTimeKind.Local).AddTicks(2030));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 732, DateTimeKind.Local).AddTicks(6160));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 732, DateTimeKind.Local).AddTicks(9505));
            ...
            modelBuilder.Entity("Store_2.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 11, 19, 13, 26, 733, DateTimeKind.Local).AddTicks(2395));
