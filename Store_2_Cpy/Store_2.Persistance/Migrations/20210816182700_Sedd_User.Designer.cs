...
namespace Store_2.Persistance.Migrations
{
    ...
    [Migration("20210816182700_Sedd_User")]
    partial class Sedd_User
    {
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 607, DateTimeKind.Local).AddTicks(9095));
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 623, DateTimeKind.Local).AddTicks(1549));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 624, DateTimeKind.Local).AddTicks(1241));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 625, DateTimeKind.Local).AddTicks(540));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 625, DateTimeKind.Local).AddTicks(4940));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogItemFavorite", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 625, DateTimeKind.Local).AddTicks(8882));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 626, DateTimeKind.Local).AddTicks(3105));
            ...
            modelBuilder.Entity("Store_2.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 626, DateTimeKind.Local).AddTicks(8908));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 627, DateTimeKind.Local).AddTicks(5735));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 628, DateTimeKind.Local).AddTicks(481));
            ...
            modelBuilder.Entity("Store_2.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 628, DateTimeKind.Local).AddTicks(3418));
            ...
            modelBuilder.Entity("Store_2.Domain.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0a1513b0-48e4-4576-998c-b1fb78fa27da",
                            Email = "mamad@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PasswordHash = "m0916789037M@",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2b734070-93d7-4307-8818-3320b24bfcfb",
            ...
            modelBuilder.Entity("Store_2.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 16, 22, 56, 58, 628, DateTimeKind.Local).AddTicks(5855));
