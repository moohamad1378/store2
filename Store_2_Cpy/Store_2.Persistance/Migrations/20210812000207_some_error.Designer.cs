...
namespace Store_2.Persistance.Migrations
{
    ...
    [Migration("20210812000207_some_error")]
    partial class some_error
    {
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 395, DateTimeKind.Local).AddTicks(4402));
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 411, DateTimeKind.Local).AddTicks(8987));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 412, DateTimeKind.Local).AddTicks(3808));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 412, DateTimeKind.Local).AddTicks(6870));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 412, DateTimeKind.Local).AddTicks(9058));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 413, DateTimeKind.Local).AddTicks(1194));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 413, DateTimeKind.Local).AddTicks(4920));
            ...
            modelBuilder.Entity("Store_2.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 413, DateTimeKind.Local).AddTicks(8062));
            ...
            modelBuilder.Entity("Store_2.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 12, 4, 32, 6, 414, DateTimeKind.Local).AddTicks(130));
