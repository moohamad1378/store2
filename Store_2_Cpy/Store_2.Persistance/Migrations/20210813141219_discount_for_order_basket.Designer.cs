...
namespace Store_2.Persistance.Migrations
{
    ...
    [Migration("20210813141219_discount_for_order_basket")]
    partial class discount_for_order_basket
    {
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 323, DateTimeKind.Local).AddTicks(1639));
            ...
            modelBuilder.Entity("Store_2.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 341, DateTimeKind.Local).AddTicks(9630));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 342, DateTimeKind.Local).AddTicks(6246));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CataLogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 343, DateTimeKind.Local).AddTicks(3949));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 343, DateTimeKind.Local).AddTicks(8328));
            ...
            modelBuilder.Entity("Store_2.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 344, DateTimeKind.Local).AddTicks(3508));
            ...
            modelBuilder.Entity("Store_2.Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 346, DateTimeKind.Local).AddTicks(1348));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 346, DateTimeKind.Local).AddTicks(9575));
            ...
            modelBuilder.Entity("Store_2.Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 347, DateTimeKind.Local).AddTicks(6777));
            ...
            modelBuilder.Entity("Store_2.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 348, DateTimeKind.Local).AddTicks(936));
            ...
            modelBuilder.Entity("Store_2.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 13, 18, 42, 17, 348, DateTimeKind.Local).AddTicks(5046));
